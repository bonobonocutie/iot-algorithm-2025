...
- 빅오 표기법(빠른 순)
    ...
    - $O(n)$ : 단순 for문
    - $O(n \cdot logn)$ : 이중 for문인데 안쪽 for문이 전체 중 일부만 처리
    - $O(n^2)$ : 이중 for문
    - $O(n^3)$ : 삼중 for문
    - $O(2^n)$ : 팩토리얼 등 ...
...
## 2일차
- 기초 문법
    -리스트 컴프리헨션 복습 : [노트북](./day02/da01_list_agin.ipynb)

- 자료구조
    - 선형 리스트 :  [노트북](./day02/da03_linear_list.py)
...
- 자료구조/알고리즘
    - 재귀호출
        ...
        - 프랙탈 연습
          ...
          https://github.com/user-attachments/assets/0f47897b-30cd-4926-a85d-69515a000c14
